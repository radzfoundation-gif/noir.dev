        ...
        return (
            <div className="fixed inset-0 z-[100] flex items-center justify-center">
                ...
                <div className="relative w-full max-w-md mx-4 bg-[#0a0a0a] border border-white/10 rounded-2xl shadow-2xl p-8 text-center animate-fade-in-up">
                    ...
                    <p className="text-zinc-400 mb-6">We've sent a confirmation link to <span className="text-white">{email}</span></p>
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center">
            ...
            <div className="relative w-full max-w-md mx-4 bg-[#0a0a0a] border border-white/10 rounded-2xl shadow-2xl overflow-hidden animate-fade-in-up">
                ...
                <div className="p-8">
                    ...
                    <p className="text-zinc-400 mb-6">Start building amazing projects today</p>
                    ...
                    <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    className="w-full rounded-lg border border-zinc-700 bg-[#121212] text-white h-11 pl-11 pr-12 text-sm focus:border-lime-500 outline-none transition-all"
                                    placeholder="••••••••"
                    ...
                    <button
                        className="flex w-full items-center justify-center gap-2 rounded-lg border border-zinc-700 bg-black h-11 text-sm font-medium text-zinc-300 hover:bg-zinc-900 transition-colors"
                        type="button"
                    ...
                    <p className="mt-6 text-center text-sm text-zinc-500">
                        ...
                        <button onClick={onSwitchToLogin} className="text-lime-400 font-semibold hover:underline">
                            Sign in
                        </button>
                    </p>
                </div>
