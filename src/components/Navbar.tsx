        ...
        >
            <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
                ...
                <div className="hidden md:flex items-center gap-8 text-sm font-medium text-white/90 drop-shadow-md">
                    <Link to="/workspace" className="hover:text-lime-400 transition-colors">Start Building</Link>
                ...
                <div className="flex items-center gap-4">
                    {user ? (
                        ...
                        <button
                            ...
                            className="group relative px-4 py-2 text-sm font-semibold text-black bg-lime-400 rounded-full hover:bg-lime-300 transition-all overflow-hidden shadow-[0_0_20px_rgba(163,230,53,0.3)] hover:shadow-[0_0_30px_rgba(163,230,53,0.5)]"
                        >
